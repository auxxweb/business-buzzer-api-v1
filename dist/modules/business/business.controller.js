...
const updateBusinessStatusByAdmin = errorWrapper(async (req, res, next) => {
    ...
    const data = await businessService.updateBusinessStatusByAdmin(req.params.id, req.body?.status);
    return responseUtils.success(res, {
        data,
        status: 200,
    });
...
export { businessSignUp, businessLogin, getBusinessById, getAllBusiness, getBusinessByCategory, updateBusiness, updateBusinessByAdmin, updateBusinessStatusByAdmin, getBusinessProfile, updateBusinessPassword, getAllBusinessByAdmin, deleteBusinessByAdmin, businessExists, getAllBusinessForDropDown, getBusinessDashboardData, addProduct, };
