    ...
    for (const range of weekRanges) {
        const count = await Business.countDocuments({
            createdAt: {
                ...
                $lt: range.endOfWeek < startOfNextMonth
                    ? range.endOfWeek
...
const getAdminDashboardData = async () => {
    const [totalPlans, totalBusiness, totalCategories, totalPayments, totalActiveBusiness, totalExpiredBusiness, totalBlockedBusiness, totalSuccessPayments, totalPendingPayments, totalFailedPayments,] = await Promise.all([
...
const getAdminDashboardChartData = async () => {
    ...
    const previousMonthCounts = await getWeeklyCounts(previousMonth, previousMonthYear);
